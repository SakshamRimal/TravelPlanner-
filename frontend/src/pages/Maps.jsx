...
import { IconSearch, IconMapPin, IconMap2, IconStar, IconMapSearch } from '@tabler/icons-react';
...
const QUICK_SEARCHES = ['Restaurants', 'Hotels', 'ATMs', 'Hospitals', 'Temples'];
  ...
  const handleSearch = async (e, searchQuery) => {
    ...
    try {
      ...
      if (withCoords.length > 0) {
        setCenter([withCoords[0].lat, withCoords[0].lng]);
        mapKey.current += 1;
      }
    } catch {
        ...
        <div className="map-panel">
          ...
          <div className="map-container">
            ...
            >
              ...
              {filteredResults.length > 0 && <MapController results={filteredResults} />}
          ...
          {loading ? (
            ...
            <>
              <div className="results-header">
                ...
                <span className="coords-info">{filteredResults.length} with coordinates</span>
              </div>
              <div className="results-list">
            ...
            <div className="idle-results">
              ...
              <div className="idle-results-sub">Try: restaurants, hotels, temples, cafes</div>
