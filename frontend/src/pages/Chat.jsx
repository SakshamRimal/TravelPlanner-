    ...
    return (
      <ReactMarkdown
        components={{
          ...
          h2: ({ children }) => <h2 style={{ fontSize: 16, fontWeight: 600, margin: '6px 0 4px' }}>{children}</h2>,
    ...
    if (messages.length === 0) {
      return (
        <div className="flex flex-col items-center justify-center h-full px-4">
          ...
          >
            Ask me anything about destinations, itineraries, budgets, packing lists, or travel tips.
          </p>
          <div
            style={{
              display: 'grid',
        ...
        >
          ...
          <div style={{ maxWidth: '70%' }}>
            ...
            {showTimestamp && (
              ...
              >
                {msg.isError ? null : (
                  <span style={{ marginLeft: 42 }}>{formatTime(msg.timestamp)}</span>
                )}
              </div>
            )}
          </div>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ fontSize: 12, color: '#6B7280' }}>Trip context:</span>
            <select
